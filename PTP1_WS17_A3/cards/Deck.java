...
public class Deck {
    ...
    public boolean equals( final Object otherObject ){
        ...
        //
        final Deck other = (Deck)( otherObject );
        if(( pack1st!=other.pack1st ) && (( null==pack1st ) || ( ! pack1st.equals( other.pack1st ))))  return false;
        if(( pack2nd!=other.pack2nd ) && (( null==pack2nd ) || ( ! pack2nd.equals( other.pack2nd ))))  return false;
        return true;
    }//method()
